...
if(isset($result)) {
   echo "<script>alert('Serive Data Deleted Successfully');window.location.href='services.php';</script>";
} else {
   echo "<script>alert('Serive Data Not Deleted');window.location.href='services.php';</script>";
}
?>