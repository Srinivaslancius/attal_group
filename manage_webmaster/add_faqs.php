      ...
      if (!isset($_POST['submit']))  {
          ...
          echo "fail";
            ...
            $status = $_POST['status'];
                    ...
                    $sql = "INSERT INTO `faqs` (`faq_cat_id`, `question`,`answer`,`status`) VALUES ('$faq_category','$question','$answer','$status')";
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="post" enctype="multipart/form-data">
                  <?php $getCategories = getDataFromTables('faq_categories','0',$clause=NULL,$id=NULL,$activeStatus=NULL,$activeTop=NULL);?>
                  <div class="form-group">
                    <label for="form-control-3" class="control-label">Choose your Category</label>
                    <select id="form-control-3" name="faq_category" class="custom-select" data-error="This field is required." required>
                      <option value="">Select Category</option>
                      <?php while($row = $getCategories->fetch_assoc()) {  ?>
                        <option value="<?php echo $row['id']; ?>"><?php echo $row['faq_category']; ?></option>
                      <?php } ?>
                   </select>
