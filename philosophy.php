...
<section class="inner-intro bg bg-fixed bg-overlay-black-70" style="background-image:url(images/bg/bg-2.jpg);">
  <div class="container">
     <div class="row intro-title text-center">
           <div class="col-sm-12">
				<div class="section-title"><h1 class="title text-white">Philosophy</h1></div>
           </div>
           <div class="col-sm-12">
         ...
         <div class="sidebar">
           <div class="service-nav">
             <ul>
               ...
               <li><a class="active" href="philosophy.php">Philosophy</a></li>
         ...
         <div class="service-block">
          ...
          <div class="row text-justify">
             ...
             <div class="col-lg-6 col-md-6"> 
               <p>Legend properties are created as holistic spaces replete with all the essentials that enrich life – from basic functionality to thoughtful value additions. Our residential and commercial spaces reflect the best in aesthetics and functionality with sufficient opportunity for customization. These spaces are designed with maximum ventilation enabling ample natural light and indicate optimum utilization of space.</p>
			   <p>We believe these are factors that impact the happiness quotient of people inhabiting a space. Innovative value additions require us to go beyond the ordinary, even if it means furnishing a residential complex with a home theatre room or private guestrooms. Legend properties aim to be spaces that are the last word in convenience and functionality, while maintaining their aesthetic value.</p>
             </div>
            </div>
          <div class="row text-justify"> 
             <div class="col-lg-12 col-md-12 mt-20">
               <p class="mb-20">Our aim is to build quality spaces that meet the expectations we have established with our customers and our goal is satisfied customers who recommend us without reservation. We believe in establishing and maintaining relationships with our customers by being accessible and going the extra mile in providing post-sale services; be it by repainting external facades or organizing yearly get-togethers. Every satisfied customer reinstates our conviction in building properties that are a celebration of life.</p>
             </div>
            </div>
         </div>
       </div>
