...
<section class="inner-intro bg bg-fixed bg-overlay-black-70" style="background-image:url(images/bg/bg-2.jpg);">
  <div class="container">
     <div class="row intro-title text-center">
           <div class="col-sm-12">
				<div class="section-title"><h1 class="title text-white">Promoters</h1></div>
           </div>
           <div class="col-sm-12">
       ...
       <div class="col-lg-3 col-md-3">
         <div class="sidebar">
           <div class="service-nav">
             <ul>
               ...
               <li><a class="active" href="promoters.php">Promoters</a></li>
        ...
        <div class="col-lg-9 col-md-9">
         <div class="service-block">
           <div class="row">
             <div class="col-lg-12 col-md-12">
               <h4 class="mb-20">Authors of Legend</h4>
             </div>
           </div>
          <div class="row text-justify">  
             <div class="col-lg-3 col-md-3 mb-20"> 
               <img src="images/about/B-Nageshwar-Rao.jpg" alt="">
             </div>
             <div class="col-lg-9 col-md-9"> 
               <h5 class="mb-10">Mr.B.Nageshwar Rao.</h5>
			   <p><b>Managing Director</b></p>
			   <p>Mr. Rao graduated in Civil Engineering from Bangalore University. He came with over a decade's experience in the construction business in the Middle East and Hyderabad prior to starting Legend.</p>
             </div>
            </div>
         </div>
       </div>
